lucid.html.bootstrap.tags.formGroup = function(factory){
	...
	this.tag = 'div';
	this.allowedAttributes.push('useRowLayout');
	this.allowedAttributes.push('useCheckableLayout');
	this.allowedAttributes.push('checkableLayoutClass');
